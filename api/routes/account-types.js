...
router.post('/', verifyJwt, verifyAdmin, (req, res, next) => {
...
router.get('/:accountTypeId', (req, res, next) => {
...
router.patch('/:accountTypeId', verifyJwt, verifyAdmin, (req, res, next) => {
    const id = req.params.accountTypeId;
...
router.delete('/:accountTypeId', verifyJwt, verifyAdmin, (req, res, next) => {
    const id = req.params.accountTypeId;
